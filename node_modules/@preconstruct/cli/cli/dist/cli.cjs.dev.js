...
class Entrypoint extends Item {
  constructor(filePath, contents, pkg) {
    ...
    _defineProperty$2(this, "_sourceCached", void 0);
  ...
  get source() {
    if (this._sourceCached === undefined) {
      this._sourceCached = resolve.sync(path.join(this.directory, this.configSource), {
...
async function writeDevTSFile(entrypoint, entrypointSourceContent) {
  let hasDefaultExport = await entrypointHasDefaultExport(entrypoint, entrypointSourceContent);
